...
def ankang_open_notes_with_quote(
    ...
    save_path = profile_data_file("ankang_sidebar_notes.json")
    legacy_txt = profile_data_file("ankang_sidebar_notes.txt")
...
class NotesWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._save_path = profile_data_file("ankang_sidebar_notes.json")
        self._legacy_txt = profile_data_file("ankang_sidebar_notes.txt")
